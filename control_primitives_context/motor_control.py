...
control_api.rotate(degrees=45) # rotate robot left by 45 degrees, avoid rotating by more than 30 degrees at a time
control_api.rotate(degrees=-45) # rotate robot right by 45 degrees, avoid rotating by more than 30 degrees at a time