zcontrol_api.read_left_sensor() # return 1.0, meaning that the left proximity sensor is reading that the nearest object on the left is approximately 1.0 meter away
