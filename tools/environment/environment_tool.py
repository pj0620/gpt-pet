...
class EnvironmentTool(BaseTool):
  ...
  description = ("Environment to verify programs for gptpet. "
                 "Use this to write Python programs that control gptpet to complete tasks. "
                 "The input must be a valid Python program.")
